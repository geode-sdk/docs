 ...
 * (`reject-vibecoded`) The mod's **codebase entirely or mostly consists of AI-generated code** (RayDeeUx can smell...). If it appears the programmer does not understand the code that has been generated and is trying to get vibecoded mods on the index, this will result in a rejection. Using AI tools to boost productivity is fine, but fully vibecoding mods will inevitably lead to instability and crashes.
